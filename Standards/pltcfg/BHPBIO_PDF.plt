...
;  Current Revision:
;  $RCSfile: pdf.plt,v $
;  $Revision: 1.1.2.18 $  $Date: 2004/03/23 21:08:23 $
;
;----------------------------------------------------------------------
...
weight_strokes(mm)=(0.18, 0.25, 0.35, 0.50, 0.75, 1.00, 1.25, 1.50, 1.75, 2.00, 2.25, 2.375, \
                    2.50, 2.75, 3.00, 3.25, 3.50, 3.75, 4.00, 4.10, \
...
pixel_resolution=150    ; Resolution of pixels on output (dpi)  Default=150
